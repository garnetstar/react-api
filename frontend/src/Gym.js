...
class Gym extends Component {
	...
	componentDidMount() {
		...
		this.client.get('/api/gym?type=1&order=desc&type=' + this.state.type, callback)
	...
	addForm() {
		...
		return (
			<div className='row main-content'>
						...
						<div className='col-sm-12'>
							...
							<form onSubmit={this.handleSubmit} className='form-horizontal'>
								<div className='form-group'>
									...
									<input type='date' id='dateId' className='form-control' onChange={this.handleDate}
								...
								<div className='form-group'>
									<input type='number' onChange={this.handleGymValue} ref={this.refInputNumber}
										   value={this.state.gymValue}/>
				...
				<div className='col-sm-6'>
					<GymList items={items} error={this.state.loadIemsError}
							 onDeleteClick={(e, i) => this.handleDelete(e, i)}/>
				</div>
			</div>
		);
	}
	...
	loadItems(callback, typeId) {
		...
		this.client.get(
			'/api/gym?type=1&order=desc&type=' + typeId,
			(result) => {
